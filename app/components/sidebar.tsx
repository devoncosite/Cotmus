...
import PrivateAIIcon from "../icons/privateai.svg";
  ...
  return (
    ...
    >
      <SideBarHeader
        ...
        shouldNarrow={shouldNarrow}
      >
        {/* Search History — top of sidebar */}
        <div className={styles["sidebar-search-item"]}>
          <IconButton
            icon={<HistoryIcon />}
            text={shouldNarrow ? undefined : Locale.SearchChat.Page.Title}
            className={styles["sidebar-tool-button"]}
            onClick={() =>
        ...
        <div className={styles["sidebar-new-chat"]}>
          <IconButton
            ...
            className={styles["sidebar-new-chat-button"]}
            onClick={() => {
        ...
        <div className={styles["sidebar-tools-list"]}>
          <IconButton
            icon={<MaskIcon />}
          ...
          <IconButton
            icon={<SdIcon />}
            text={shouldNarrow ? undefined : "Stable Diffusion"}
            className={styles["sidebar-tool-button"]}
      ...
      {!shouldNarrow && (
        <div className={styles["sidebar-section-label"]}>RECENT</div>
      )}
